...
public class TestAdapter {
	...
	public void updateLikeForParking(int soLike, String maParking){
    	try {
	    	String updateLike = "Update tbl_parking SET like = " + soLike + "WHERE ma_parking = '" + maParking + "'";
	    	Log.d("Update", updateLike);
	    	SQLiteDatabase db = mBRDbHelper.getWritableDatabase();
	    	db.execSQL(updateLike);
	    	db.close();
